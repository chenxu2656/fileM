<template>
  <div id="container">
    ...
    <el-menu :default-active="activePath" class="el-menu-vertical-demo" :collapse="isCollapse" @select="handleUpdate">
      <el-menu-item index="home" @click="routerPush(router, '/stuAdmin')">
        <el-icon><img src="../../../public/images/icons/dashboard.svg" alt=""></el-icon>
        <span class="tit">正在申报</span>
      </el-menu-item>
    
      <el-sub-menu index="my">
        <template #title>
          <el-icon><img src="../../../public/images/icons/user.svg" alt=""></el-icon>
          <span class="tit">我的申报</span>
        </template>
        <el-menu-item-group>
          <el-menu-item index="admin" @click="routerPush(router, '/stuAdmin/projectlist')">
            <span class="tit">我创建的</span>
          </el-menu-item>
          <el-menu-item index="stu" @click="routerPush(router, '/stuAdmin/projectlistJ')">
            <span class="tit">我参与的</span></el-menu-item>
        </el-menu-item-group>
      </el-sub-menu>
      <el-sub-menu index="myprofile">
        <template #title>
          <el-icon><img src="../../../public/images/icons/setting.svg" alt=""></el-icon>
          <span class="tit">信息维护</span>
        </template>
        <el-menu-item-group>
          <el-menu-item index="editprofile" @click="routerPush(router, '/stuAdmin/editp')">
            <span class="tit">信息管理</span>
          </el-menu-item>
          <el-menu-item index="restPw" @click="routerPush(router, '/stuAdmin/editp')">
            <span class="tit">重置密码</span></el-menu-item>
        </el-menu-item-group>
      </el-sub-menu>
